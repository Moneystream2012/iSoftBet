  ...
  methods: {
    ...
    getAllQueryParams () {
      ...
      if (typeof(this.queryParams) === 'function') {
        params = this.queryParams(this.sortOrder, this.offset, this.limit)
        return typeof(params) !== 'object' ? {} : params
      }

      params[this.queryParams.sortBy] = 'id desc'; //this.getSortParam()
      params[this.queryParams.offset] = (this.currentPage - 1) * this.perPage
      params[this.queryParams.limit] = this.perPage

      params[this.queryParams.amountFrom] = 0
      params[this.queryParams.amountTo] = 10000
      params[this.queryParams.dateFrom] = '2019-01-01'
      params[this.queryParams.dateTo] = '2019-12-01'
