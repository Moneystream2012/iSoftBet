<template>
    <div class="container">
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <router-link class="navbar-brand" to="/home">(c)iSoftBet</router-link>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <router-link class="nav-item" tag="li" to="/customers" active-class="active">
                        <a class="nav-link">Customers</a>
                    </router-link>

                    <router-link class="nav-item" tag="li" to="/transactions" active-class="active">
